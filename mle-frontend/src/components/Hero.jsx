					...
					<section className="text-gray-600 body-font overflow-hidden">
						<div className="container mx-auto flex flex-col items-center justify-center">
							<motion.img
								...
								initial="hidden"
								animate={mainControls}
								transition={{ duration: 2, delay: 0.50, ease: "easeInOut" }}
							...
							<motion.div
								...
								<p className="mb-8 leading-relaxed text-gray-500 dark:text-gray-400 px-3">
									...
									Chambray dreamcatcher trust fund, kitsch vice godard disrupt ramps hexagon mustache
									umami snackwave tilde chillwave ugh.
								</p>
								<motion.div
									variants={variants}
									initial="hidden"
